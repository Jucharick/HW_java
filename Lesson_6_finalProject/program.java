...
public class program {
    public static void main(String[] args) {
        ...
        setLaptop.add(new Laptop("macos", 1321, 450, 64, 8, 1050, "black"));
        setLaptop.add(new Laptop("windows", 1750, 500, 128, 12, 1150, "grey"));
        setLaptop.add(new Laptop("stratodesk", 1298, 450, 128, 12, 950, "black"));
        setLaptop.add(new Laptop("sindows", 1752, 500, 64, 8, 950, "red"));
        setLaptop.add(new Laptop("macos", 1298, 350, 32, 8, 750, "yellow"));
